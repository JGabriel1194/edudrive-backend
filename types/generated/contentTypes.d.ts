...
export interface ApiAcademicPeriodAcademicPeriod
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lisense: Schema.Attribute.Relation<'manyToOne', 'api::lisense.lisense'>;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academic_period: Schema.Attribute.Relation<
      'oneToOne',
      'api::academic-period.academic-period'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    parallels: Schema.Attribute.Relation<'oneToMany', 'api::parallel.parallel'>;
    publishedAt: Schema.Attribute.DateTime;
    study_plan: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::enrollment.enrollment'
    >;
    parallel: Schema.Attribute.Relation<'manyToOne', 'api::parallel.parallel'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLisenseLisense extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academic_periods: Schema.Attribute.Relation<
      'oneToMany',
      'api::academic-period.academic-period'
    >;
    ...
    state: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    study_plans: Schema.Attribute.Relation<
      'oneToMany',
      'api::study-plan.study-plan'
    >;
...
export interface ApiParallelParallel extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lisense.lisense': ApiLisenseLisense;
      'api::parallel.parallel': ApiParallelParallel;
